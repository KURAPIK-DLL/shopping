...
<table class="cart-table table table-bordered">
				...
				<tbody>
					...
					foreach ($cart as $key => $value) {
						...
						$cartsql = " SELECT * FROM produits  WHERE  id = $key ";
					...
					<tr>
						...
						<td>
							<span class="amount"><?php echo $cartr['price']; ?>US $</span>					
						</td>
						<td>
						...
						<td>
							<span class="amount"><?php echo $cartr['price']*$value['quantity'];  ?> US $</span>					
						</td>
					</tr>
						...
						<td colspan="6" class="actions">
							...
							<div class="col-md-6">
								<div class="cart-btn">
									...
									<button class="button btn-md"  type="submit"><a href="pdf.php">Checkout</a></button>
								</div>
							</div>
						</td>
					</tr>
				...
				<div class="col-md-6 push-md-6 no-padding">
					...
					<table class="table table-bordered col-md-6">
						<tbody>
							<tr>
								<th>Cart Subtotal</th>
								<td><span class="amount"><?php echo $total; ?> US $</span></td>
							</tr>
							<tr>
							...
							<tr>
								<th>Order Total</th>
								<td><strong><span class="amount"><?php echo $total; ?> US $</span></strong> </td>
							</tr>
						</tbody>
					</table>
				</div>
